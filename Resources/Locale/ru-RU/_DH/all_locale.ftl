...
GaslockFrameMachineCircuitboard = портативный газовый шлюз (машинная плата)
    .desc = Машинная плата для портативного газового шлюза.

ClothingWalletLeatherBrown = кожаный кошелек
 .desc = Удивительно толстый. Будьте осторожны, чтобы не потерять его, и не садитесь на него.
ClothingWalletLeatherBlack = { ent-ClothingWalletLeatherBrown }
 .desc = Удивительно толстый. Будьте осторожны, чтобы не потерять его, и не садитесь на него. Теперь в чёрной расцветке!
ClothingWalletLeatherGreen = { ent-ClothingWalletLeatherBrown }
 .desc = Удивительно толстый. Будьте осторожны, чтобы не потерять его, и не садитесь на него. Теперь в зелёной расцветке!
ClothingWalletLeatherMail = { ent-ClothingWalletLeatherBrown }
 .desc = Внутри вышиты изображение кошки, сердечка и слово "CLIPPY".
ClothingWalletLeatherPirate = { ent-ClothingWalletLeatherBrown }
 .desc = Внутри есть старая фотография кота с бородой.
ClothingWalletLeatherPrisoner = { ent-ClothingWalletLeatherBrown }
 .desc = Это не то, чего вы ожидали.
ClothingWalletLeatherPink = { ent-ClothingWalletLeatherBrown }
 .desc = Удивительно толстый. Будьте осторожны, чтобы не потерять его, и не садитесь на него. Теперь в малиновой расцветке!
ClothingWalletLeatherWhite = { ent-ClothingWalletLeatherBrown }
 .desc = Удивительно толстый. Будьте осторожны, чтобы не потерять его, и не садитесь на него. Теперь в белой расцветке!
ClothingWalletLeatherPurple = { ent-ClothingWalletLeatherBrown }
...
CondimentCupDispenser = диспенсер для приправ
 ...
 .suffix = Пустой
CondimentCupDispenser10 = диспенсер для приправ
 .desc = В нём хранятся маленькие стаканчики для приправ. Производитель утверждает, что они изготовлены из переработанных материалов.
CondimentCup = чашка для приправ
 .desc = Хлипкая кружка, которую можно наполнить приправами. Гарантия аннулируется, если кружка наполнена чем-либо другим.
CondimentDispenser = раздатчик приправ
 .desc = Дозатор для приправ с одним отделением для стаканчика с приправой.
CondimentDispenserEmpty = раздатчик приправ
 .desc = Дозатор для приправ с одним отделением для стаканчика с приправой.
CondimentDispenserCircuitboard = раздатчик приправ (машинная плата)
    .desc = Машинная плата для раздатчика приправ.

DangerTether = Точка привязки опасностей
    .desc = Опасные объекты на этой карте (сингулярности, теслы) должны находиться в пределах 500 м от одного из этих объектов.

NFInflatableDoor = надувная дверь
    .desc = Дверь, куда она ведёт?
NFInflatableDoorWindow = надувная оконная дверь
    .desc = Дверь, куда она ведёт?
NFInflatableDoorStack1 = надувная дверь
    .suffix = 1
NFInflatableDoorStack = надувная дверь
    .suffix = Полный
NFInflatableDoorWindowStack = надувная оконная дверь
    .suffix = Полный
NFInflatableDoorWindowStack1 = надувная оконная дверь
    .suffix = 1
NFInflatableDock = надувной внешний шлюз
    .desc = Надувной шлюз с усиленными точками крепления, способная к стыковке. Активируйте для спуска воздуха. Не прокалывайте.
NFInflatableDockStack = надувной внешний шлюз
    .suffix = Полный
NFInflatableDockStack1 = надувной внешний шлюз
    .suffix = 1
NFInflatableWall = надувная стена
    .desc = Надутая стена. Активируйте, чтобы спустить воздух. Не прокалывайте.
NFInflatableWallStack1 = надувная стена
    .suffix = 1
NFInflatableWallStack5 = надувная стена
    .suffix = 5
NFInflatableWallStack = надувная стена
    .suffix = Полный
NFInflatableWindow = надувное окно
    .desc = Надутое окно. Активируйте, чтобы спустить воздух. Не прокалывайте.
NFInflatableWindowStack1 = надувное окно
    .suffix = 1
NFInflatableWindowStack5 = надувное окно
    .suffix = 5
NFInflatableWindowStack = надувное окно
    .suffix = Полный
NFInflatableCrate = надувной ящик
    .desc = Одноразовый надувной контейнер для хранения. Не сдувается. Не прокалывать.
NFInflatableCrateStack = надувной ящик
    .suffix = Полный
NFInflatableCrateStack1 = надувной ящик
    .suffix = 1

BorgChassisSelectable = Киборг
...
NFDetectiveIDCard = ID карта детектива дсбф
    .desc = { ent-IDCardStandard.desc }
NFDetectivePDA = КПК детектива
    .desc = Пахнет дождем... льет с крыш...

PlushieDave = плюшевый Дэйв
    .desc = Уважаемый человек!

ThrusterLuaBuildMachineCircuitboard = двигатель LuaTech (машинная плата)
    .desc = Машинная плата для двигателя LuaTech.
RustedThruster = ржавый двигатель
    .desc = Не подлежащий ремонту двигатель, вышедший из строя из-за износа. Пригоден только для утилизации.
PortableSMESMachineCircuitboard = портативный СМЭС (машинная плата)
    .desc = Машинная плата для портативного СМЭСa.
PortableSMESEmpty = портативный СМЭС
    .desc = Портативный SMES. Зарядка осуществляется через высоковольтный кабель, затем напряжение понижается до низковольтного.
    .suffix = Пустой
PortableSMES = портативный СМЭС
    .desc = Портативный SMES. Зарядка осуществляется через высоковольтный кабель, затем напряжение понижается до низковольтного.

SmallBluespaceAirTank = карманный блюспейс газовый баллон
    .desc = Компактный газовый блюспейс баллон. Вмещает 10 литров газа.
BluespaceAirTank = блюспейс газовый баллон
    .desc = Расширенный топливный блюспейс баллон. Вмещает 20 литров газа.
DoubleEmergencyTankO2N2Equal = двойной аварийный O2/N2 баллон
...
DoubleEmergencyTankO2N2EqualFilled = двойной аварийный O2/N2 баллон
    .desc = Высококачественный двухбаллонный контейнер для оказания экстренной медицинской помощи: в одном баллоне находится азот (N2), в другом — кислород (O2). Несмотря на свои небольшие размеры, он вмещает достаточное количество газа — 2,5 л.
    .suffix = Заполнен

ShuttersWindowCentralCommand = { ent-ShuttersWindow }
    .desc = { ent-ShuttersWindow.desc }
    .suffix = Центральное Командование

WireBrush = проволочная щетка
    .desc = Щетка из щетины стальной проволоки, идеально подходящая для удаления даже самых стойких пятен ржавчины.
IntergalacticTranslator = переводчик
    .desc = Переводит речь.

WallWeaponCapacitorRechargerAssembly = каркас настенного зарядника
    .desc = { ent-WallWeaponCapacitorRecharger.desc }
PortablePump = портативный насос
...
CockSpike= петушиный крюк
    .desc = Для всех любителей делать >w<.

BoxPaperColored = коробка цветной бумаги
    .desc = Коробка, полная цветной бумаги.
PaperColoredRed = бумага
    .desc = «Кусок красной бумаги».
PaperColoredOrange = бумага
    .desc = «Оранжевой красной бумаги».
PaperColoredYellow = бумага
    .desc = «Жёлтой красной бумаги».
PaperColoredGreen = бумага
    .desc = «Зелёной красной бумаги».
PaperColoredBlue = бумага
    .desc = «Синей красной бумаги».
PaperColoredPurple = бумага
...
ScienceMothershipComputer = консоль научной верфи
...
PoweredWarmSmallLight = { ent-PoweredSmallLight }
...
ParcelWrapTrash = обёрточная бумага
    .desc = Неутешительные остатки неупакованной посылки.
ParcelDropoff = почтовый ящик
...
ShiparmoryResearchAndDevelopmentServerFlatpack = упакованный корабельный сервер РНД
